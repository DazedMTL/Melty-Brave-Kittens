...
(function () {
  ...
  Params = {
    ...
    CateSortType: CheckParam(
      "num",
      "Category_Sort_Type",
      Parameters["Category_Sort_Type"],
      0
    ),
    MapSlotWindow: {
      SizeRate: CheckParam(
    ...
    if (command.toLowerCase() === "itemslot") {
      switch (args[0].toLowerCase()) {
        ...
        case "set":
          ...
          if (args[2]) {
            if (
              (args[2].toLowerCase() == WEAPON && Params.SlotSetW[0]) ||
              (args[2].toLowerCase() == ARMOR && Params.SlotSetA[0]) ||
              args[2].toLowerCase() == ITEM
            ) {
        ...
        case "select":
          if (args[1] != "") {
            if (slotToIndex(args[1].toLowerCase()) != -1) {
              if (scene && scene.constructor == Scene_Map) {
                scene._mapItemSlotWindow.select(
                  slotToIndex(args[1].toLowerCase())
                );
              }
            }
          }
  ...
  Window_ItemSlotList.prototype.makeItemList = function () {
    ...
    if (
      (!Params.SlotSetW[0] && !Params.SlotSetA[0]) ||
      Params.CateSortType[0] == 0
    ) {
