...
(function () {
  ...
  Game_Actors.prototype.getActorProperty = function (
    actor,
    propertyName,
    args
  ) {
  ...
  Game_Party.prototype.addTradeRecord = function (
    item,
    amount,
    gold,
    tradeType
  ...
  Game_TradeRecord.prototype.getSumRecord = function (
    counterArray,
    startIndex,
    endIndex
  ) {
    ...
    return counterArray
      ...
      .reduce(function (sumValue, value) {
        return sumValue + value;
      }, 0);
  };
  ...
  Scene_Shop.prototype.doBuy = function (number) {
    ...
    $gameParty.addTradeRecord(
      this._item,
      number,
      number * this.buyingPrice(),
      "Buy"
    );
  };
