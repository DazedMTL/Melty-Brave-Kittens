...
(function () {
  ...
  Karberus.FollowerOpt.FollowerCollision = String(
    Karberus.Parameters["Follower Collision"]
  );
  Karberus.FollowerOpt.getIDforBalloon = 0;

  var Karb_Game_Interpreter_pluginCommand =
  ...
  Game_Interpreter.prototype.command213 = function () {
    if (Karberus.FollowerOpt.getIDforBalloon > 0) {
      this._character =
        $gamePlayer._followers._data[Karberus.FollowerOpt.getIDforBalloon - 1];
      if (this._character) {
  ...
  Game_Followers.prototype.moveFollower = function (follower_direction) {
    this._data[Karberus.FollowerOpt.WhichFollower - 1].moveStraight(
      follower_direction
    );
  };
  Game_Followers.prototype.moveDiagonallyFollower = function (
    follower_direction1,
    follower_direction2
  ) {
    this._data[Karberus.FollowerOpt.WhichFollower - 1].moveDiagonally(
      follower_direction1,
      follower_direction2
    );
  };
  Game_Followers.prototype.setDirectionFollower = function (
    follower_direction
  ) {
    this._data[Karberus.FollowerOpt.WhichFollower - 1].setDirection(
      follower_direction
    );
  };
  ...
  Game_Followers.prototype.setThroughFollower = function (followerSwitch) {
    this._data[Karberus.FollowerOpt.WhichFollower - 1].setThrough(
      followerSwitch
    );
  };
  ...
  _Karb_Game_Character_updateRoutineMove =
