...
(function (global) {
  ...
  Window_InputSymbolList.prototype = Object.create(
    Window_InputSymbolList.baseType
  );
  ...
  Window_GamepadConfig_MA.prototype = Object.create(
    Window_GamepadConfig_MA.baseType.prototype
  );
  ...
  Window_GamepadConfig_MA.prototype.initialize = function () {
    ...
    Window_GamepadConfig_MA.baseType.prototype.initialize.call(
      this,
      x,
      y,
      w,
  ...
  Window_GamepadConfig_MA.prototype.setButtonItem = function (
    index,
    buttonNumber
  ) {
  ...
  Scene_InputConfigBase_MA.prototype = Object.create(
    Scene_InputConfigBase_MA.baseType
  );
  ...
  Scene_GamepadConfigMA.prototype = Object.create(
    Scene_GamepadConfigMA.baseType
  );
  ...
  Window_KeyConfig_MA.prototype.initialize = function () {
    ...
    Window_KeyConfig_MA.baseType.initialize.call(
      this,
      0,
      0,
      Graphics.boxWidth,
  ...
  Window_KeyConfig_MA.COMMAND_DEFAULT = keyinfoEX(
    setting.commandText.default_,
    0,
    true
  );
  Window_KeyConfig_MA.COMMAND_APPLY = keyinfoEX(
    setting.commandText.apply,
    0,
    true
  );
  Window_KeyConfig_MA.COMMAND_EXIT = keyinfoEX(
    setting.commandText.exit,
    0,
    true
  );
  Window_KeyConfig_MA.COMMAND_CHANGE_LAYOUT = keyinfoEX(
  ...
  Window_KeyConfig_MA.prototype.enterRect = function () {
    const rect = Window_KeyConfig_MA.baseType.itemRect.call(
      this,
      this.enterIndex()
    );
  ...
  Window_KeyConfig_MA.prototype.isSpaceIndex = function (index) {
    ...
    return (
      spaceStart <= index && index < spaceStart + Window_KeyConfig_MA.spaceItems
    );
  };
  ...
  Window_KeyConfig_MA.prototype.drawItemText = function (
    keyName,
    symobolText,
    x,
    y,
  ...
  function createExportFunction() {
    const exportList = [symbolToButtonName];
    var result = {};
