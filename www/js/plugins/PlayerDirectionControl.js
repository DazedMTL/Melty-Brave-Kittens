...
(function () {
  ...
  Game_Interpreter.prototype.execControlPlayerDirection = function (args) {
    $gamePlayer.setControlDirections(
  ...
  Game_CharacterBase.prototype.modifyDirectionByDirectionControl = function (
    prevDirection
  ) {
    if (
      !this.isDirectionFixed() &&
      !this._controlDirections.contains(this._direction)
    ) {
      this._direction = prevDirection;
    }
  };

  Game_CharacterBase.prototype.setControlDirections = function (
    controlDirections
  ) {
