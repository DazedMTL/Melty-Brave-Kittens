...
EXA.FC.pluginParams.allowedList =
  EXA.FC.pluginParams["Interpreter Commands"] || "205,212,213";
...
EXA.FC.Game_Interpreter_pluginCommand =
...
EXA.FC.Game_Interpreter_executeCommand =
...
Game_Player.prototype.isCollidedWithCharacters = function (x, y) {
  return (
    this.isCollidedWithFollowers(x, y) ||
