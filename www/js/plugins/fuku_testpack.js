...
(function () {
  ...
  Window_Message.prototype.updateInput = function () {
    if (Input.isTriggered(Fuku_Plugins.MessageCtrl.nowaittoggle)) {
      Fuku_Plugins.MessageCtrl.nowaitmode =
        !Fuku_Plugins.MessageCtrl.nowaitmode;
      Input.update();
      return true;
    }
  ...
  Window_Message.prototype.updateWait = function () {
    if (Fuku_Plugins.MessageCtrl.enable) {
      if (
        Fuku_Plugins.MessageCtrl.nowaitmode ||
        Input.isPressed(Fuku_Plugins.MessageCtrl.skipbutton)
      ) {
        if (this._textState) {
...
(function () {
  ...
  Fuku_Plugins.OverlapEvents.handlers.switch_on = function (
    watcher,
    first,
    param
  ) {
  ...
  Fuku_Plugins.OverlapEvents.handlers.info_set = function (
    watcher,
    first,
    param
  ) {
    if (first) {
      ...
      if (param[1])
        $gameVariables.setValue(param[1], watcher.getTargetObject().getId()); //監視対象のID
      if (param[2])
        $gameVariables.setValue(param[2], watcher.getPairObject().getId()); //監視対象に重なったID
      return true;
    }
    if ($gameSwitches.value(param[0])) return true; //ONにしたスイッチがOFFになるまで進めない
    return false;
  };
  Fuku_Plugins.OverlapEvents.handlers.commonevent = function (
    watcher,
    first,
    param
  ) {
    ...
    if (first) {
      ...
      if (commonevent) {
        ...
        if (Fuku_Plugins.OverlapEvents._interpreter.setEventInfo) {
          //for com1.3
          Fuku_Plugins.OverlapEvents._interpreter.setEventInfo({
  ...
  Fuku_Plugins.OverlapEvents.IRect.prototype.constructor =
    Fuku_Plugins.OverlapEvents.IRect;
  ...
  Fuku_Plugins.OverlapEvents.PictureRect =
    Fuku_Plugins_OverlapEvents_PictureRect;
  Fuku_Plugins.OverlapEvents.PictureRect.prototype = Object.create(
    Fuku_Plugins.OverlapEvents.IRect.prototype
  );
  Fuku_Plugins.OverlapEvents.PictureRect.prototype.constructor =
    Fuku_Plugins.OverlapEvents.PictureRect;
      ...
      if (bitmap && bitmap.isReady()) {
        if (picture.origin() === 0) {
          ...
          this.right = Math.floor(
            this.left + (picture.scaleX() * bitmap.width) / 100
          );
          this.bottom = Math.floor(
            this.top + (picture.scaleY() * bitmap.height) / 100
          );
        } else {
          this.left = Math.floor(
            picture.x() - (picture.scaleX() * bitmap.width) / 200
          );
          this.top = Math.floor(
            picture.y() - (picture.scaleY() * bitmap.height) / 200
          );
          this.right = Math.floor(
            this.left + (picture.scaleX() * bitmap.width) / 100
          );
  ...
  Fuku_Plugins.OverlapEvents.CharacterRect =
    Fuku_Plugins_OverlapEvents_CharacterRect;
  Fuku_Plugins.OverlapEvents.CharacterRect.prototype = Object.create(
    Fuku_Plugins.OverlapEvents.IRect.prototype
  );
  Fuku_Plugins.OverlapEvents.CharacterRect.prototype.constructor =
    Fuku_Plugins.OverlapEvents.CharacterRect;

  Fuku_Plugins.OverlapEvents.PictureRect.prototype.object = function () {
    return this._id < 0 ? $gamePlayer : $gameMap.event(this._id);
  };
  Fuku_Plugins.OverlapEvents.CharacterRect.prototype.syncRect = function (
    event
  ) {
    var width, height;
    if (event._tileId > 0) {
      //isTileの定義が何故かGame/Spriteで異なるためSprite側を使用
  ...
  Fuku_Plugins.OverlapEvents.IOverlapWatcher = function (
    target,
    on_handler,
    on_param,
    off_handler,
  ...
  Fuku_Plugins.OverlapEvents.IOverlapWatcher.prototype.constructor =
    Fuku_Plugins.OverlapEvents.IOverlapWatcher;
  ...
  Fuku_Plugins.OverlapEvents.IOverlapWatcher.prototype._setOnTrigger =
    function (pair) {
  ...
  Fuku_Plugins.OverlapEvents.IOverlapWatcher.prototype.getPairObject =
    function () {
      return this._triggerpair;
    };
  Fuku_Plugins.OverlapEvents.IOverlapWatcher.prototype.getTargetObject =
    function () {
      return this._target;
    };
  Fuku_Plugins.OverlapEvents.IOverlapWatcher.prototype.isOnTriggered =
    function () {
      return this._on_triggered;
    };
  Fuku_Plugins.OverlapEvents.IOverlapWatcher.prototype.isOffTriggered =
    function () {
  ...
  Fuku_Plugins.OverlapEvents.IOverlapWatcher.prototype.dispatch = function () {
    if (this._on_triggered) {
      ...
      if (handler)
        this._on_triggered = handler(this, this._trigger_first, this._on_param);
  ...
  Fuku_Plugins_OverlapEvents_ArrayWatcher = function (
    target,
    on_handler,
    on_param,
    off_handler,
  ...
  Fuku_Plugins.OverlapEvents.ArrayWatcher =
    Fuku_Plugins_OverlapEvents_ArrayWatcher;
  Fuku_Plugins.OverlapEvents.ArrayWatcher.prototype = Object.create(
    Fuku_Plugins.OverlapEvents.IOverlapWatcher.prototype
  );
  Fuku_Plugins.OverlapEvents.ArrayWatcher.prototype.constructor =
    Fuku_Plugins.OverlapEvents.ArrayWatcher;

  Fuku_Plugins.OverlapEvents.ArrayWatcher.prototype.setPairList = function (
    list
  ) {
    this._pairlist = list;
  };
  ...
  Fuku_Plugins_OverlapEvents_AllEventWatcher = function (
    target,
    on_handler,
    on_param,
    off_handler,
  ...
  Fuku_Plugins.OverlapEvents.AllEventWatcher =
    Fuku_Plugins_OverlapEvents_AllEventWatcher;
  Fuku_Plugins.OverlapEvents.AllEventWatcher.prototype = Object.create(
    Fuku_Plugins.OverlapEvents.IOverlapWatcher.prototype
  );
  Fuku_Plugins.OverlapEvents.AllEventWatcher.prototype.constructor =
    Fuku_Plugins.OverlapEvents.AllEventWatcher;
  ...
  Fuku_Plugins.OverlapEvents.PlayerWatcher =
    Fuku_Plugins_OverlapEvents_PlayerWatcher;
  Fuku_Plugins.OverlapEvents.PlayerWatcher.prototype = Object.create(
    Fuku_Plugins.OverlapEvents.IOverlapWatcher.prototype
  );
  Fuku_Plugins.OverlapEvents.PlayerWatcher.prototype.constructor =
    Fuku_Plugins.OverlapEvents.PlayerWatcher;
  ...
  Fuku_Plugins.OverlapEvents.AllPictureWatcher =
    Fuku_Plugins_OverlapEvents_AllPictureWatcher;
  Fuku_Plugins.OverlapEvents.AllPictureWatcher.prototype = Object.create(
    Fuku_Plugins.OverlapEvents.IOverlapWatcher.prototype
  );
  Fuku_Plugins.OverlapEvents.AllPictureWatcher.prototype.constructor =
    Fuku_Plugins.OverlapEvents.AllPictureWatcher;
  ...
  Fuku_Plugins.OverlapEvents.AllPictureWatcher.prototype.update = function () {
    ...
    var exc_id = -1;
    if (target instanceof Fuku_Plugins.OverlapEvents.PictureRect)
      exc_id = target.getId();
  ...
  DataManager.makeSaveContents = function () {
    ...
    contents.Fuku_OverlapEvents.oneshotwatch =
      Fuku_Plugins.OverlapEvents.oneshotwatch;
    contents.Fuku_OverlapEvents._lastcheck_list =
      Fuku_Plugins.OverlapEvents._lastcheck_list;
    contents.Fuku_OverlapEvents._lastcheck_index =
      Fuku_Plugins.OverlapEvents._lastcheck_index;
    contents.Fuku_OverlapEvents._interpreter =
      Fuku_Plugins.OverlapEvents._interpreter;
    contents.Fuku_OverlapEvents.call_watcher =
      Fuku_Plugins.OverlapEvents.call_watcher;
    return contents;
  };
...
(function () {
  ...
  Game_Battler.prototype.fukuPushAdditionalAnimation = function (animelist) {
    this._fuku_add_animelist = (this._fuku_add_animelist || []).concat(
      animelist
    );
  };
  ...
  Window_BattleLog.prototype.startAction = function (subject, action, targets) {
    ...
    if (item.meta.fuku_addanime) {
      if (!(item.meta.fuku_addanime instanceof Array)) {
        item.meta.fuku_addanime = item.meta.fuku_addanime
          .split(",")
          .map(function (id) {
            return Number(id);
          });
...
(function () {
  ...
  Fuku_Plugins.SimpleParticle.ParticleSprite.prototype = Object.create(
    Sprite.prototype
  );
  Fuku_Plugins.SimpleParticle.ParticleSprite.prototype.constructor =
    Fuku_Plugins.SimpleParticle.ParticleSprite;

  Fuku_Plugins.SimpleParticle.ParticleSprite.prototype.eraseParticle =
    function () {
  ...
  Fuku_Plugins.SimpleParticle.ParticleSprite.prototype.showParticle = function (
    parent,
    imgname,
    x,
    y,
  ...
  Fuku_Plugins.SimpleParticle.ParticleSprite.prototype.update = function () {
    ...
    this.move(
      this.x + Math.cos(this._angle) * this._speed,
      this.y + Math.sin(this._angle) * this._speed
    );
    this.opacity =
      this._opt_start +
      (this._opt_end - this._opt_start) *
        (this._now_frames / this._part_frames);
  };

  Fuku_Plugins.SimpleParticle.create = function (
    parent,
    imgname,
    x,
    y,
